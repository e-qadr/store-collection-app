...
class CollectorEditRequestsScreen extends StatefulWidget {
  ...
  const CollectorEditRequestsScreen({
    super.key,
  ...
  @override
  State<CollectorEditRequestsScreen> createState() =>
      _CollectorEditRequestsScreenState();
}
...
class _CollectorEditRequestsScreenState
                          ...
                          try {
                            ...
                            if (context.mounted) {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                  content: Text(
                                    'تم تعديل السند وإعادة إرساله بنجاح',
                                  ),
  ...
  Future<void> _rejectEditRequest(
    String transactionId,
              ...
              return Center(
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'لا توجد أي سندات تتطلب التعديل حالياً.',
                      style: TextStyle(
                        fontSize: 16,
                            ...
                            children: [
                              ...
                              Expanded(
                                ...
                                child: OutlinedButton.icon(
                                  onPressed: () =>
                                      _rejectEditRequest(doc.id, data),
                                  icon: const Icon(
                                    Icons.close_rounded,
                                    size: 18,
                                  ),
