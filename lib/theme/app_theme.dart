...
class AppTheme {
  ...
  // ── Role Gradients ─────────────────────────────────────────────────
  static const List<Color> managerGradient    = [Color(0xFF0D47A1), Color(0xFF1565C0), Color(0xFF1E88E5)];
  static const List<Color> collectorGradient  = [Color(0xFF004D40), Color(0xFF00695C), Color(0xFF00897B)];
  static const List<Color> accountantGradient = [Color(0xFF311B92), Color(0xFF4527A0), Color(0xFF5E35B1)];
  static const List<Color> adminGradient      = [Color(0xFF4A148C), Color(0xFF6A1B9A), Color(0xFF7B1FA2)];

  // ── Status Helpers ────────────────────────────────────────────────
  static Color statusColor(String status) {
    switch (status) {
      case 'pending':                     return pendingColor;
      case 'approvedByCollector':         return managerColor;
      case 'approvedByManager':           return collectorColor;
      case 'approvedByAccountant':        return successColor;
      case 'editRequestedByCollector':    return errorColor;
      case 'pendingApprovalOfEdit':       return const Color(0xFFF9A825);
      case 'reviewRequestedByAccountant': return accountantColor;
      case 'reviewRequestedByManager':    return managerColor;
      case 'rejectedByManager':           return const Color(0xFFB71C1C);
  ...
  static String statusLabel(String status) {
    switch (status) {
      ...
      case 'approvedByAccountant':        return 'مكتمل نهائياً';
      case 'editRequestedByCollector':    return 'يتطلب تعديل';
      case 'pendingApprovalOfEdit':       return 'تعديل بانتظار الموافقة';
      case 'reviewRequestedByAccountant': return 'مراجعة المحاسب';
      case 'reviewRequestedByManager':    return 'مراجعة المدير';
  ...
  static ThemeData get lightTheme {
    ...
    return ThemeData(
      ...
      textTheme: const TextTheme(
        ...
        bodySmall:      TextStyle(fontSize: 11, fontWeight: FontWeight.normal, color: textHint),
