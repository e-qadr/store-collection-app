  ...
  static String safeMessageForCode(String code) {
    return switch (code) {
      ...
      'brand-identifier-invalid' =>
        'رمز العلامة التجاري لفواتير المناقلات غير صالح. تواصل مع الإدارة.',
      'brand-counter-invalid' =>
        'عداد فواتير العلامة التجاري غير صالح. تواصل مع الإدارة، ولم يتم استهلاك أي رقم.',
